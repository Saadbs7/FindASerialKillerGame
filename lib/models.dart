...
Gender genderFromJson(String value) => Gender.values.firstWhere(
      (candidate) => candidate.name == value.toLowerCase(),
      orElse: () => throw FormatException('Unsupported gender: $value'),
    );
ClueSource clueSourceFromJson(String value) =>
    ClueSource.values.firstWhere((e) => e.name == value.toLowerCase(),
        orElse: () => throw FormatException('Unsupported clue source: $value'));
ClueStrength clueStrengthFromJson(String value) =>
    ClueStrength.values.firstWhere((e) => e.name == value.toLowerCase(),
        orElse: () =>
            throw FormatException('Unsupported clue strength: $value'));
...
class GogglesData {
  const GogglesData(
      ...
      required this.inactiveFormerConnections,
...
class ClueDefinition {
  const ClueDefinition(
      {required this.id,
      required this.source,
      required this.strength,
      required this.description,
      required this.relatedClueIds,
      required this.developerExplanation});
  final String id;
  ...
  factory ClueDefinition.fromJson(Map<String, dynamic> json) => ClueDefinition(
        ...
        relatedClueIds:
            List<String>.from(json['relatedClueIds'] as List? ?? const []),
...
class Profile {
  ...
  factory Profile.fromJson(Map<String, dynamic> json) => Profile(
        ...
        lookingFor: json['lookingFor'] as String? ?? json['intent'] as String,
        interests: List<String>.from(json['interests'] as List),
        photos: List<String>.from(json['photos'] as List),
        questions: (json['questions'] as List? ?? const [])
            .map((e) =>
                ProfileQuestion.fromJson(Map<String, dynamic>.from(e as Map)))
            .toList(growable: false),
        gogglesData: GogglesData.fromJson(
            Map<String, dynamic>.from(json['gogglesData'] as Map)),
        conversationId: json['conversationId'] as String,
        isKiller: json['isKiller'] as bool? ?? false,
        clues: (json['clues'] as List? ?? const [])
            .map((e) =>
                ClueDefinition.fromJson(Map<String, dynamic>.from(e as Map)))
            .toList(growable: false),
        redHerrings:
            List<String>.from(json['redHerrings'] as List? ?? const []),
      );
}

enum CaseIntelligenceBlockType {
  paragraph,
  bullets,
  callout,
  quote,
...
class CaseIntelligenceBlock {
  const CaseIntelligenceBlock({
    required this.type,
    this.heading,
    this.text = '',
    this.items = const [],
  ...
  final CaseIntelligenceBlockType type;
  final String? heading;
  final String text;
  final List<String> items;

  Iterable<String> get contentParts sync* {
    if (type == CaseIntelligenceBlockType.bullets ||
        type == CaseIntelligenceBlockType.timeline) {
      yield* items;
    } else {
      yield text;
    }
  ...
  factory CaseIntelligenceBlock.fromJson(Map<String, dynamic> json) {
    final typeName = json['type'] as String;
    final type = CaseIntelligenceBlockType.values.firstWhere(
      (candidate) => candidate.name == typeName,
      orElse: () => throw FormatException(
        'Unsupported case intelligence block type: $typeName',
      ),
    );
    return CaseIntelligenceBlock(
      type: type,
...
class Level {
  const Level(
      ...
      required this.killerProfileId,
      required this.caseDescription,
      this.caseIntelligenceFormat = const []});
  final String id;
  final Gender gender;
  final String title;
  ...
  final List<CaseIntelligenceBlock> caseIntelligenceFormat;
  factory Level.fromJson(Map<String, dynamic> json) => Level(
        ...
        caseIntelligenceFormat:
            (json['caseIntelligenceFormat'] as List? ?? const [])
                .map((item) => CaseIntelligenceBlock.fromJson(
...
class ResponseOption {
  ...
  factory ResponseOption.fromJson(Map<String, dynamic> json) => ResponseOption(
      ...
      suspectReply: json['suspectReply'] as String,
      nextStageId: json['nextStageId'] as String?,
      optionalClueId: json['optionalClueId'] as String?);
}

class ConversationStage {
  const ConversationStage(
      {required this.id,
      required this.suspectMessage,
      required this.responseOptions});
  final String id;
  final String suspectMessage;
  final List<ResponseOption> responseOptions;
  factory ConversationStage.fromJson(Map<String, dynamic> json) =>
      ConversationStage(
          id: json['id'] as String,
          suspectMessage: json['suspectMessage'] as String,
          responseOptions: (json['responseOptions'] as List)
              .map((e) =>
                  ResponseOption.fromJson(Map<String, dynamic>.from(e as Map)))
              .toList(growable: false));
}
  ...
  factory Conversation.fromJson(String id, Map<String, dynamic> json) =>
      Conversation(
          ...
          stages: (json['stages'] as List)
              .map((e) => ConversationStage.fromJson(
...
class ChatEntry {
  ...
  factory ChatEntry.fromJson(Map<String, dynamic> json) => ChatEntry(
      isPlayer: json['isPlayer'] as bool, text: json['text'] as String);
}
